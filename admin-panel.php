...
function generate_bill(){
  ...
  while($row = mysqli_fetch_array($query)){
    // XSS FIX: escape all DB values before injecting into HTML
    $output .= '
    <label> Patient ID : </label>'.h($row["pid"]).'<br/><br/>
    <label> Appointment ID : </label>'.h($row["ID"]).'<br/><br/>
    <label> Patient Name : </label>'.h($row["fname"]).' '.h($row["lname"]).'<br/><br/>
    <label> Doctor Name : </label>'.h($row["doctor"]).'<br/><br/>
    <label> Appointment Date : </label>'.h($row["appdate"]).'<br/><br/>
    <label> Appointment Time : </label>'.h($row["apptime"]).'<br/><br/>
    <label> Disease : </label>'.h($row["disease"]).'<br/><br/>
    <label> Allergies : </label>'.h($row["allergy"]).'<br/><br/>
    <label> Prescription : </label>'.h($row["prescription"]).'<br/><br/>
    <label> Fees Paid : </label>'.h($row["docFees"]).'<br/>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Welcome &nbsp<?php echo h($username) ?> 
   </h3>
    <div class="row">
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        <td><?php echo h($row['doctor']);?></td>
                        <td><?php echo h($row['docFees']);?></td>
                        <td><?php echo h($row['appdate']);?></td>
                        <td><?php echo h($row['apptime']);?></td>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo h($row['appdate']);?></td>
                        <td><?php echo h($row['apptime']);?></td>
                        <td><?php echo h($row['disease']);?></td>
                        <td><?php echo h($row['allergy']);?></td>
