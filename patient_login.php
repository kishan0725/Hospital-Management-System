...
<<<<<<< HEAD
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="register.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp GLOBAL HOSPITALS</h4></a>
...
<<<<<<< HEAD
                ...
                <form class="form-group" method="POST" action="patient_auth.php">
                  <div class="row" style="margin-top: 10%">
                    ...
                    <div class="col-md-8"><input type="email" name="email" class="form-control" placeholder="enter email ID" required/></div><br><br>
              ...
              <form class="form-group" method="POST" action="patient_auth.php">
                ...
                <div class="row">
                 ...
                 <!--  <div class="col-md-8" style="margin-top: 10%">
                    <a href="register.php" class="btn btn-primary">Back</a></div> -->
                </div>
              </form>
            </center>
            </div>
