...
> Sample user: nancy@gmail.com password: nancy123
...
> Sample user: Tiwary password: tiwary123
...
> Sample user: admin password: admin123
...
Just run this to create the database and start the application
```
docker-compose up -d
```
